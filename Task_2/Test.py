...
#
# var = 2 * 10000
# print(hyper_tangent(var))
# print(hyper_tangent(np.clip(var, -370, 370)))
...
def train_model():
    # Create an instance of the MLPClassifier (replace this with your MLP training code)
    ...
    for epoch in tqdm(range(num_epochs), desc='Training Progress'):
        ...
        # Update progress bar
        progress['value'] = (epoch + 1) * (100 / num_epochs)
...
root = tk.Tk()
root.title("MLP Training Progress")
