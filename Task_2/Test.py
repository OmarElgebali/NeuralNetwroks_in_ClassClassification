...
from Core import x_train, y_train, x_test, y_test
...
def predict(xs, act_function):
    ys_predicts, _ = feed_forward(xs, act_function)
...
predict(xInputToPredict[0], "Sigmoid")
