...
def prepare(algorithm, feature_1_name, feature_2_name, classes_encode_number):
    global encoder_model, scaler_f1_model, scaler_f2_model, encoded_class_train, norm_feature_1_train, norm_feature_2_train, encoded_class_test, norm_feature_1_test, norm_feature_2_test
...
def fit(algorithm, epochs, eta, mse, bias):
    global label_test_prediction, adaline_model, perceptron_weights
    if algorithm == 'Perceptron':
        perceptron_weights = Perceptron.perceptron_train(norm_feature_1_train, norm_feature_2_train, encoded_class_train, eta, epochs)
        label_test_prediction = Perceptron.perceptron_test(norm_feature_1_test, norm_feature_2_test, encoded_class_test, perceptron_weights)
